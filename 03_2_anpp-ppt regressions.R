...
### 
{
  ...
  ppt1yrPlot <- ggplot(filter(npp_ppt_means,npp_type=="ANPP"), aes(x=rain_year_ppt_mean, y=npp_mean, ymin=npp_mean-npp_se, ymax=npp_mean+npp_se, fill=factor(Drought), shape=factor(Year))) +
    geom_errorbar(width=5, col="black") +
  ...
  # prev year
  ggplot(filter(npp_ppt_2yr_means,npp_type=="ANPP"), aes(x=ppt_prev1, y=npp_mean, ymin=npp_mean-npp_se, ymax=npp_mean+npp_se, col=factor(Year), shape=factor(Drought))) +
    geom_errorbar(width=5) +
    geom_point() +
    geom_smooth(inherit.aes=F, aes(x=ppt_prev1, y=npp_mean), method="lm", se=F, col="black") +
    facet_wrap(~Site, scales="free_y")
  ...
  test(emtrends(current_ppt_anpp_lm, "Site", var="rain_year_ppt"))
  ...
  summary(lm(npp_mean~ppt_2Yr_mean*Site, data=filter(npp_ppt_2yr_means,npp_type=="totNPP"&Site=="TB")))
  summary(lm(npp_mean~ppt_2Yr_mean, data=filter(npp_ppt_2yr_means,npp_type=="totNPP"&Site=="FK")))
  summary(lm(npp_mean~ppt_2Yr_mean, data=filter(npp_ppt_2yr_means,npp_type=="ANPP"&Site=="FK")))
  summary(lm(npp_gm2~ppt_prev1, data=filter(npp_ppt_df,npp_type=="BNPP"&Site=="TB")))
  summary(lm(npp_gm2~ppt_prev1, data=filter(npp_ppt_df,npp_type=="BNPP"&Site=="FK")))
  
  ### Models using mean values in each year and trt
  summary(lm(npp_mean~ppt_2Yr_mean, data=filter(npp_ppt_2yr_means,npp_type=="totNPP"&Site=="TB")))
  summary(lm(npp_mean~ppt_2Yr_mean, data=filter(npp_ppt_2yr_means,npp_type=="totNPP"&Site=="FK")))
  summary(lm(npp_mean~ppt_2Yr_mean, data=filter(npp_ppt_2yr_means,npp_type=="ANPP"&Site=="TB")))
  summary(lm(npp_mean~ppt_2Yr_mean, data=filter(npp_ppt_2yr_means,npp_type=="ANPP"&Site=="FK")))
  summary(lm(npp_gm2~ppt_prev1, data=filter(npp_ppt_df,npp_type=="BNPP"&Site=="TB")))
  summary(lm(npp_gm2~ppt_prev1, data=filter(npp_ppt_df,npp_type=="BNPP"&Site=="FK")))
  
  
  tb_totnpp_model <- lm(npp_mean~ppt_2Yr_mean+, data=filter(npp_ppt_2yr_means,npp_type=="totNPP"&Site=="TB"))
...
###
{
  ...
  ggplot(subset(npp_ppt_grz_means,Site=="TB"&Year==2021&npp_type=="ANPP"), 
         aes(x=rain_year_ppt_mean, y=npp_mean, ymin=npp_mean-npp_se, ymax=npp_mean+npp_se)) +
    geom_errorbar(width=5) +
    geom_point(size=3) +
    #  geom_smooth(inherit.aes=F, aes(x=rain_year_ppt_mean, y=npp_mean), method="lm", se=F, col="black") +
    geom_smooth()
  ...
  ggplot(subset(npp_ppt_grz_means,Site=="FK"&Year==2021&npp_type=="ANPP"), 
